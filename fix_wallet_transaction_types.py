#!/usr/bin/env python
"""
Script để cập nhật lại transaction_type cho các giao dịch ví
được tạo tự động từ Finance Transaction
"""
import os
import django
...
def fix_transaction_types():
    """
    Cập nhật lại transaction_type cho các giao dịch ví
    dựa trên category type của giao dịch tài chính gốc
    """
...
if __name__ == '__main__':
    print("Bắt đầu cập nhật transaction_type cho giao dịch ví...")
    print("="*60)
